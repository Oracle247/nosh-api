...
export const formatOrderItemUpdate = (item: ICreateOrderItem) => {
  return {
    quantity: item.quantity,
    orderItemModifiers: {
      upsert: item.modifiers?.map((mod) => ({
...
export const formatOrderItemCreate = (item: ICreateOrderItem, orderId: string) => {
  return {
